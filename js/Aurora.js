...
window.onload = function() {
    audio = document.getElementById("iamyf");
    // audio.play();
    console.log(audio);
}
var $ = {};
...
$.Part.prototype.draw = function() {
    ...
    $.ctx.fillRect((this.sx + $.rand(-sparkleRadius, sparkleRadius)), (this.sy + $.rand(-sparkleRadius, sparkleRadius)),
        1, 1);
